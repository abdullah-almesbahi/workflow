...
$this->title = Yii::t('admin', 'Additional Fields');
...
<div class="row">
    ...
    DynaGrid::widget([
        'columns' => [
            [
                'attribute' => 'name',
                'label' => Yii::t('admin', 'Name (Internal)'),
                'order'=>DynaGrid::ORDER_FIX_LEFT,
            ],

            [
                'attribute' => 'title',
                'label' => Yii::t('admin', 'Title (For Display)'),
                'order'=>DynaGrid::ORDER_FIX_LEFT,
            ],
            [
                'attribute' => 'sql_type',
                'label' => Yii::t('admin', 'Sql Type'),
                'order'=>DynaGrid::ORDER_FIX_LEFT,
            ],
            [
                'attribute' => 'field_type',
                'label' => Yii::t('admin', 'Field Type'),
                'order'=>DynaGrid::ORDER_FIX_LEFT,

            ],
            [
                'attribute' => 'validate_func',
                'label' => Yii::t('admin', 'Validation function'),
                'order'=>DynaGrid::ORDER_FIX_LEFT,
        ...
        'gridOptions'=>[
            ...
            'toolbar' =>  [
                ['content'=> Html::a('<i class="glyphicon glyphicon-plus"></i>', ['af-update'] , ['data-pjax'=>0, 'class' => 'btn btn-primary', 'title'=>Yii::t('admin','Add') ])],
