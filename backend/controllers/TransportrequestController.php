...
class TransportrequestController extends CrudController
{
    public static $modelClass = '\backend\models\TransportRequest';
    public static $tableName = 'transportrequest';
