...
$(document).ready(function () {
    ...
    //**********************************BEGIN MAIN MENU********************************
    //TODO: auto open main menu if we are on submenu
    ...
    //***********************************BEGIN Grids*****************************		
    $('.panel .tools a.remove').on('click', function () {
        var removable = jQuery(this).parents(".panel");
        if (removable.next().hasClass('panel') || removable.prev().hasClass('panel')) {
    ...
    $('.panel .tools a.reload').on('click', function () {
    ...
    $('.panel .tools .collapse, .grid .tools .expand').on('click', function () {
        var el = jQuery(this).parents(".panel").children(".panel-body");
        var ef = jQuery(this).parents(".panel").children(".panel-footer");
